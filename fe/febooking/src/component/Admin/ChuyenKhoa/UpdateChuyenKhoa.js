...
import { callUploadDoctorImg, updateChuyenKhoa } from "../../../services/apidoctor";
    ...
    useEffect(() => {
        if(openModalUpdate && dataUpdate?._id){
            ...
            if (dataUpdate.image) {
                ...
                console.log(`ảnh: http://localhost:3001/uploads/${dataUpdate.image}`);
                ...
                setFileList([
                    {
                        ...
                        url: `http://localhost:3001/uploads//${dataUpdate.image}`, // Đường dẫn đến hình ảnh
                    },
                ]);                
            }
            const init = {
