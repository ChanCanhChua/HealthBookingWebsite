...
const UpdateAdmin = (props) => {
    ...
    const {
        dataUpdateAdmin, setDataUpdateAdmin,
        openUpdateAdmin, setOpenUpdateAdmin,
        fetchListAdmin
    } = props
    ...
    useEffect(() => {
        if (openUpdateAdmin && dataUpdateAdmin?._id) {       
            ...
            const init = {
                _id: dataUpdateAdmin._id,
                firstName: dataUpdateAdmin.firstName,
                lastName: dataUpdateAdmin.lastName,
                address: dataUpdateAdmin.address,
                email: dataUpdateAdmin.email,
                password: dataUpdateAdmin.password,
                phoneNumber: dataUpdateAdmin.phoneNumber,
                mota: dataUpdateAdmin.mota || '',                    
            }
    ...
    },[dataUpdateAdmin, openUpdateAdmin])

    console.log("dataUpdateAdmin: ", dataUpdateAdmin);
    ...
    return (
        <Modal
            title={`Sửa thông Admin có email là ${dataUpdateAdmin?.email}`}
            style={{
                top: 20,
            }}
